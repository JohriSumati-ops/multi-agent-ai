...
---------------------
Stub implementation of BaseLLM for Anthropic Claude models (claude-sonnet, claude-opus, etc.).
...
"claude" to ClaudeProvider, constructed with whatever
...
class ClaudeProvider(BaseLLM):
    """Stub provider for Anthropic Claude models (claude-sonnet, claude-opus, etc.)"""

    provider_name = "claude"

    def __init__(self, model_name: str = "claude-default", **config: Any) -> None:
