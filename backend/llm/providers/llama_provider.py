"""
llm/providers/llama_provider.py

WHY THIS FILE EXISTS
---------------------
Stub implementation of BaseLLM for Meta Llama models, typically self-hosted via Ollama or vLLM.
...
"llama" to LlamaProvider, constructed with whatever
...
class LlamaProvider(BaseLLM):
    """Stub provider for Meta Llama models, typically self-hosted via Ollama or vLLM"""

    provider_name = "llama"

    def __init__(self, model_name: str = "llama-default", **config: Any) -> None:
