"""
llm/providers/mistral_provider.py

WHY THIS FILE EXISTS
---------------------
Stub implementation of BaseLLM for Mistral AI models.
...
"mistral" to MistralProvider, constructed with whatever
...
class MistralProvider(BaseLLM):
    """Stub provider for Mistral AI models"""

    provider_name = "mistral"

    def __init__(self, model_name: str = "mistral-default", **config: Any) -> None:
