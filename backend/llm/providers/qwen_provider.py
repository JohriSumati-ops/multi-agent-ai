"""
llm/providers/qwen_provider.py

WHY THIS FILE EXISTS
---------------------
Stub implementation of BaseLLM for Alibaba Qwen models.
...
"qwen" to QwenProvider, constructed with whatever
...
class QwenProvider(BaseLLM):
    """Stub provider for Alibaba Qwen models"""

    provider_name = "qwen"

    def __init__(self, model_name: str = "qwen-default", **config: Any) -> None:
